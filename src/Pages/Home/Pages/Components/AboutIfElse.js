...
export default function About() {
    return(
        <div className="container-lg d-flex align-items-center flex-column justify-content-center" style={{minHeight:'100vh'}}>
            <motion.h2 initial={{opacity:0,y:100}} whileInView={{opacity:1,y:0}} transition={{duration:0.3}} className="page3-judul text-center">ABOUT IF ELSE</motion.h2>
