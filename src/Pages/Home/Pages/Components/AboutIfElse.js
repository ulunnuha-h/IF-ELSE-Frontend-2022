...
export default function About() {
    return(
        <div className="container-lg d-flex align-items-center flex-column justify-content-center" style={{minHeight:'100vh'}}>
            <h2 className="page3-judul">ABOUT IF ELSE</h2>
            <motion.p initial={{opacity:0,y:100}} whileInView={{opacity:1,y:0}} whileHover={{scale:1.01}} transition={{duration:0.3,type:'tween',ease:'circOut'}} className="page3-aboutUs text-light p-4 p-lg-5 mx-0 mx-lg-5">
