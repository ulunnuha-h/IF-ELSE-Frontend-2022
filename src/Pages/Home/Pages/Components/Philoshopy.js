...
export default function Philosophy() {
    ...
    return(
        <motion.div initial={{y:200}} whileInView={{y:0}} transition={{duration:0.3,type:'tween',ease:'circOut'}} id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel" style={{width:'460px'}}>
