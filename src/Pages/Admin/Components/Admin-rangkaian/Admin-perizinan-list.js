...
import { getPerizinanDay, togglePerizinanDay } from "../../../../Data/Perizinan";
import { PerizinanDetail } from "./Admin-perizinan-detail";

const ListPerizinan = () => {
    const rangkaian = parseInt(useParams().rangkaian);
    const data = getPerizinanDay(rangkaian);
    ...
    return(
        <>
            ...
            <div className="form-check form-switch my-2">
                <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" checked={open} onChange={()=>{setOpen(togglePerizinanDay(rangkaian))}}/>
